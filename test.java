...
class test
{
	static String s[][] = {{"D1310BA6", "98DFB5AC", "2FFD72DB", "D01ADFB7",
	...
	static String p[]={"243f6a88", "85a308d3","13198a2e","03707344","a4093822", "299f31d0", "082efa98","ec4e6c89",  "452821e6",  "38d01377","be5466cf",  "34e90c6c",  "c0ac29b7", 		"c97c50dd",  "3f84d5b5" ,"b5470917" , "9216d5d9" , "8979fb1b"};
	static conversion c=new conversion();
	static BufferedReader br=new BufferedReader(new InputStreamReader(System.in));
	public static void main(String z[])throws IOException
	{
		int i=0,j=0;
		String dp[]=new String[18];
		String k[]=new String[14];
		double d;
		...
		key=br.readLine();
		b.karray(k,key);
		//System.out.print("K array is:");
		//display(k);
		//System.out.print("P array is:");
		//display(p);
		/*d=b.psarray(s[0],d);
		//display(s[0]);
		d=b.psarray(s[1],d);
		...
		System.out.println("\nPlain text is:"+b.encrypt(dp,s,cipher));
	}
